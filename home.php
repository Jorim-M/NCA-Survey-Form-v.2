               ...
               <div class="card">
                  ...
                  <div class="card-body col-lg-12 mx-auto">
                     <form method="POST" action="save.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <?php include 'inc/7.php'?>
                           </div>
                           <div class="col-md-4">
                              <?php include 'inc/8.php'?>
                           </div>
                           <div class="col-md-4">
                              <?php include 'inc/9.php'?>
                           </div>
                        </div>
                        <br>
                        <hr>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <?php include 'inc/10.php'?>
                           </div>
                           <div class="col-md-6">
                              <?php include 'inc/11.php'?>
                           </div>
                        </div>
                        <br>
                        <hr>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <?php include 'inc/14.php'?>
                           </div>
                           <div class="col-md-4">
                              <?php include 'inc/15.php'?>
                           </div>
                           <div class="col-md-4">
                              <?php include 'inc/16.php'?>
                           </div>
                        </div>
                        <br>
                        <hr>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <?php include 'inc/17.php'?>
                           </div>
                           <div class="col-md-4">
                              <?php include 'inc/18.php'?>
                           </div>
                           <div class="col-md-4">
                              <?php include 'inc/19.php'?>
                           </div>
                        </div>
                        <div class="row">
